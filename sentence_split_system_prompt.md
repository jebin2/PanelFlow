...
- Do not ingore any phrase/sentence
...
Before returning the JSON, verify that you have processed every sentence from the input and have not truncate or omit any content
