"""python -m panelflow.v2.batch [--once] [--model NAME]

The inbox loop: run the v2 pipeline over every comic waiting in
...
def main(argv=None):
    parser = argparse.ArgumentParser(
        prog="panelflow-v2-batch",
        description="Run the v2 pipeline over every comic in the inbox.")
