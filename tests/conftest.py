...
def no_live_services(monkeypatch):
    ...
    monkeypatch.setattr("panelflow.providers.ttt.generate", blocked_ttt)
    monkeypatch.setattr("panelflow.providers.ocr.lines", blocked_ocr)
